...
class MoviesPage extends StatefulWidget {
  final String title;
  final ChosenMovie chosenMovies;
  const MoviesPage({Key key, this.title = "Movies", this.chosenMovies})
      : super(key: key);
...
class _MoviesPageState extends ModularState<MoviesPage, MoviesController> {
  ...
  @override
  void initState() {
    ChosenMovie movie = widget.chosenMovies;
    print("here");
        ...
        body: Column(
          children: [
                      ...
                      Container(
                          child: Opacity(
                              ...
                              child: movie.backdrop_path != null
                                  ...
                                  : Image.asset(language == "pt-BR"
                                      ? "assets/images/no-poster-ptm.png"
                                      : "assets/images/no-poster-enm.png"))),
                      Container(
                    ...
                    Column(
                      children: [
                        Container(
                          ...
                          height: movie.overview.length < 200
                              ? scale * 120
                              : scale * 180,
                          //color: Colors.white,
                          alignment: Alignment.center,
            ...
            Row(mainAxisAlignment: MainAxisAlignment.spaceAround, children: [
              ...
              Padding(
                padding:
                    EdgeInsets.only(top: scale * 10, bottom: 65, right: 20),
                child: Container(
                  width: (width / 2.5),
                  height: scale * 40,
                  decoration: BoxDecoration(
