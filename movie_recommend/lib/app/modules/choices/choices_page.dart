...
class ChoicesPage extends StatefulWidget {
  final String title;
  const ChoicesPage({Key key, this.title = "Choices"}) : super(key: key);

  @override
  _ChoicesPageState createState() => _ChoicesPageState();
}

class _ChoicesPageState extends ModularState<ChoicesPage, ChoicesController> {
    bool _isMovie = false;
    bool _isSerie = false;
              ...
              child: Row(
                ...
                children: [
                  ...
                  Opacity(
                    ...
                    child: Image.asset('assets/images/movie_image.png', scale: 1/scale))                
                  ), 
                  InkWell(onTap: () {
                    setState(() {
                  ...
                  Opacity(
                    ...
                    child: Image.asset('assets/images/popcorn_image.png', scale: 1/scale))
                  )
                ],
              )),
          Container(
