...
class SeriePage extends StatefulWidget {
  final String title;
  final ChosenSerie chosenSerie;
  const SeriePage({Key key, this.title = "Serie", this.chosenSerie}) : super(key: key);
...
bool tap = false;
      ...
      children: [
        ...
        SpeedDialChild(
          child: Padding(
            ...
            child: FaIcon(FontAwesomeIcons.solidHandPointRight, color: Colors.white),
          ),
          backgroundColor: Color(0xFFa20409), //0xFFa20409),
          onTap: () {
  ...
  @override
  void initState() {
    ChosenSerie serie = widget.chosenSerie;
    print("here");
